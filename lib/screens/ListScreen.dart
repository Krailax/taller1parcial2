...
import 'package:taller1parcial2/screens/DetailScreen.dart';
import 'package:taller1parcial2/widgets/EmailWidget.dart';
...
class _ListScreenState extends State<ListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('EMAIL Microsoft ftx Google'),
      ),
